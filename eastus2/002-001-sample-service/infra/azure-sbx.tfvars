...
ssl_password     = "#{COMPUTE_SSLCERT_PASSWORD_SBX}#" #Do Not Change - This Key/Value needs to be in a variable group library
ingress_host     = ""                                 #FIXME Input your host name - i.e. "myapp.ciodev.accenture.com"
